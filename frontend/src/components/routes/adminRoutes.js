...
const adminRoutes = () => {
  return (
    <>
    <Route path="/admin/dashboard" element={<ProtectedRoute ademin={true}><Dashboard /></ProtectedRoute>} />
    ...
    <Route path="/admin/reviews" element={<ProtectedRoute admin={true}><ProductReview /></ProtectedRoute>} />
    </>
  )
}
